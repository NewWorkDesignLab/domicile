...
public static class ScreenshotManager {
    ...
    public static List<string> takenScreenshots = new List<string>();
    ...
    public static IEnumerator SavePhoto (Action<bool> callback) {
        ...
        string fileName = $"domicile_screenshot_{System.DateTime.Now.ToString("yyyyMMddTHHmmss")}.png";
